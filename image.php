...
object-fit:cover;
border-radius: 10px;
border: 2px solid egba(255, 255, 255, 0.684);
...
<nav class="NavbarItems">
        ...
        <ul class="nav-menu">
            ...
            <li><a href="image.php" class="nav-links"><i class="fa-solid fa-image"></i> Image</a></li>
            <li><a href="video.php" class="nav-links"><i class="fa-solid fa-video"></i>Video</a></li>
            <li><a href="about.php" class="nav-links"><i class="fa-solid fa-info-circle"></i> About</a></li>
    ...
    <div class="side-menu" id="sideMenu">
        <ul>
            <li><a href="index.php" class="nav-links"><i class="fa-solid fa-home"></i> Home</a></li>
            <li><a href="image.php" class="nav-links"><i class="fa-solid fa-building"></i>Image</a></li>
            <li><a href="video.php" class="nav-links"><i class="fa-solid fa-video"></i>Video</a></li>
            <li><a href="about.php" class="nav-links"><i class="fa-solid fa-info-circle"></i> About</a></li>
    ...
    $about1 = 'indeximage/about1.jpg'; 
    $about2 = 'indeximage/about2.jpg'; 
    ?>
    ...
    <div class='first-about'>
        ...
        <div class='image'>
            <img src="<?php echo $about1; ?>" alt="image" />
            <img src="<?php echo $about2; ?>" alt="image1" />
        </div>
    </div>
    ...
    <div class='footer'>
            <div class='top'>
                ...
                <div class='social-icons'>
                    <a href="/https://www.facebook.com/profile.php?id=61566495535005&mibextid=LQQJ4d" aria-label="Facebook">
            ...
            <div class='bottom'>
                <div>
                    <h4>Community</h4>
                    <a href="https://github.com/NimeshKolambage">GitHub</a>
                    <a href="/">Issues</a>
                    <a href="/">Projects</a>
                    <a href="/">Twitter</a>
                </div>
